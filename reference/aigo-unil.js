 ...
 *
 * The object below is frozen. Its content fingerprint is cbdb4863aed9f778, which signs
 * the start, the questions, the results and the links; the signature fields it
 * does not sign (disclaimer, publisher, review, jurisdiction, legalBasis, steps,
 * languages) are frozen separately by the harness, so no part of this object can
 * move unnoticed. Only this header comment is editable.
 *
...
var AI_GO_CONTENT = {
  ...
  /* Traceability of the legal review. The engine DISPLAYS it under every
     ...
     review date is more than 548 days (18 months) old. Publisher, reviewer and date
