 ...
 *
 * USAGE: a MIGRATION verdict, frozen, never regenerated. The harness compares it
 * to the paths it enumerates; check.html prints paths in the same notation, so
 * the two lists can be read side by side, but it never loads this file.
 *
